...
def extract_metadata_from_text(text: str, file_name: str = "", extracted_title: str = "") -> dict:
    ...
    # 2. 标准名称：优先使用外部传入的标题（如 MinerU 提取），否则正则提取
    if extracted_title:
